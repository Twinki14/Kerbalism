...
namespace Kerbalism.Utility
{
    public sealed class Animator
    {
        ...
        public void Play(bool reverse, bool loop, Action callback = null)
        {
            ...
            Kerbalism.System.Kerbalism.Fetch.StartCoroutine(PlayAnimation(reverse, loop, callback));
        }
        ...
        public void Stop(Action callback = null)
        {
            ...
            Kerbalism.System.Kerbalism.Fetch.StartCoroutine(StopAnimation(callback));
        }
