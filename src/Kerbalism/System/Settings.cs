...
namespace Kerbalism.System
{
    ...
    {
        private const string MODS_INCOMPATIBLE = "";
        private const string MODS_WARNING = "RemoteTech,CommNetAntennasInfo";
        private const string MODS_SCIENCE = "KEI,[x] Science!";

        public static void Parse()
        {
            var kerbalismConfigNodes = GameDatabase.Instance.GetConfigs("Kerbalism");
            if (kerbalismConfigNodes.Length < 1) return;
            var cfg = kerbalismConfigNodes[0].config;
