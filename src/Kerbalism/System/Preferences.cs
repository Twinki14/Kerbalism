namespace Kerbalism.System
{
    ...
    {
        [GameParameters.CustomParameterUI("#KERBALISM_HighlightMalfunctions",
            toolTip = "#KERBALISM_HighlightMalfunctions_desc")]
        //Highlight Malfunctions--Highlight failed parts in flight
        public bool highlights = true;

        [GameParameters.CustomParameterUI("#KERBALISM_PartMalfunctions",
            toolTip = "#KERBALISM_PartMalfunctions_desc")]
        //Part Malfunctions--Allow engine failures based on part age and mean time between failures
        public bool mtbfFailures = true;

        [GameParameters.CustomFloatParameterUI("#KERBALISM_CriticalFailureRate", asPercentage = true, minValue = 0,
            maxValue = 1, displayFormat = "F2", toolTip = "#KERBALISM_CriticalFailureRate_desc")]
        //Critical Failure Rate---Proportion of malfunctions that lead to critical failures
        public float criticalChance = 0.25f;

        [GameParameters.CustomFloatParameterUI("#KERBALISM_FixableFailureRate", asPercentage = true, minValue = 0,
            maxValue = 1, displayFormat = "F2", toolTip = "#KERBALISM_FixableFailureRate_desc")]
        //Fixable Failure Rate--Proportion of malfunctions that can be fixed remotely
        public float safeModeChance = 0.5f;

        [GameParameters.CustomParameterUI("#KERBALISM_IncentiveRedundancy",
            toolTip = "#KERBALISM_IncentiveRedundancy_desc")]
        //Incentive Redundancy--Each malfunction will increase the MTBF\nof components in the same redundancy group
        public bool incentiveRedundancy = true;

        [GameParameters.CustomParameterUI("#KERBALISM_EngineMalfunctions",
            toolTip = "#KERBALISM_EngineMalfunctions_desc")]
        //Engine Malfunctions--Allow engine failures on ignition and exceeded burn durations
        public bool engineFailures = true;

        [GameParameters.CustomFloatParameterUI("#KERBALISM_EngineIgnitionFailureChance", asPercentage = true,
            minValue = 0, maxValue = 3, displayFormat = "F2", toolTip = "#KERBALISM_EngineIgnitionFailureChance_desc")]
        //Engine Ignition Failure Chance--Adjust the probability of engine failures on ignition
        public float ignitionFailureChance = 1.0f;

        [GameParameters.CustomFloatParameterUI("#KERBALISM_EngineBurnFailureChance", asPercentage = true, minValue = 0,
            maxValue = 3, displayFormat = "F2", toolTip = "#KERBALISM_EngineBurnFailureChance_desc")]
        //Engine Burn Failure Chance--Adjust the probability of an engine failure caused by excessive burn time
        ...
        {
            get { return Local.Preferences_Reliability; }
        } //"Reliability"
