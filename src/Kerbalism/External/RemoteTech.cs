...
namespace Kerbalism.External
{
    ...
    public static class RemoteTech
    {
        ...
        static RemoteTech()
        {
            foreach (var a in AssemblyLoader.loadedAssemblies)
            {
                if (a.name == "RemoteTech")
                {
                    ...
                    IsEnabled = (Func<bool>) Delegate.CreateDelegate(typeof(Func<bool>),
                        RT_API.GetMethod("IsRemoteTechEnabled"));
                    EnabledInSPC =
                        (Action<bool>) Delegate.CreateDelegate(typeof(Action<bool>), RT_API.GetMethod("EnableInSPC"));
                    IsConnected = (Func<Guid, bool>) Delegate.CreateDelegate(typeof(Func<Guid, bool>),
                        RT_API.GetMethod("HasAnyConnection"));
                    IsConnectedKSC = (Func<Guid, bool>) Delegate.CreateDelegate(typeof(Func<Guid, bool>),
                        RT_API.GetMethod("HasConnectionToKSC"));
                    IsTargetKSC = (Func<Guid, bool>) Delegate.CreateDelegate(typeof(Func<Guid, bool>),
                        RT_API.GetMethod("HasDirectGroundStation"));
                    NameTargetKSC = (Func<Guid, string>) Delegate.CreateDelegate(typeof(Func<Guid, string>),
                        RT_API.GetMethod("GetClosestDirectGroundStation"));
                    NameFirstHopKSC = (Func<Guid, string>) Delegate.CreateDelegate(typeof(Func<Guid, string>),
                        RT_API.GetMethod("GetFirstHopToKSC"));
                    SignalDelay = (Func<Guid, double>) Delegate.CreateDelegate(typeof(Func<Guid, double>),
                        RT_API.GetMethod("GetSignalDelayToKSC"));
                    SetRadioBlackout = (Func<Guid, bool, string, bool>) Delegate.CreateDelegate(
                        typeof(Func<Guid, bool, string, bool>), RT_API.GetMethod("SetRadioBlackoutGuid"));
                    GetRadioBlackout = (Func<Guid, bool>) Delegate.CreateDelegate(typeof(Func<Guid, bool>),
                        RT_API.GetMethod("GetRadioBlackoutGuid"));
                    SetPowerDown =
                        (Func<Guid, bool, string, bool>) Delegate.CreateDelegate(typeof(Func<Guid, bool, string, bool>),
                            RT_API.GetMethod("SetPowerDownGuid"));
                    GetPowerDown = (Func<Guid, bool>) Delegate.CreateDelegate(typeof(Func<Guid, bool>),
                        RT_API.GetMethod("GetPowerDownGuid"));
                    GetControlPath = (Func<Guid, Guid[]>) Delegate.CreateDelegate(typeof(Func<Guid, Guid[]>),
                        RT_API.GetMethod("GetControlPath"));
                    GetDistance = (Func<Guid, Guid, double>) Delegate.CreateDelegate(typeof(Func<Guid, Guid, double>),
                        RT_API.GetMethod("GetRangeDistance"));
                    GetMaxDistance =
                        (Func<Guid, Guid, double>) Delegate.CreateDelegate(typeof(Func<Guid, Guid, double>),
                            RT_API.GetMethod("GetMaxRangeDistance"));
                    GetSatName =
                        (Func<Guid, string>) Delegate.CreateDelegate(typeof(Func<Guid, string>),
                            RT_API.GetMethod("GetName"));

                    Type ModuleRTAntennaType = a.assembly.GetType("RemoteTech.Modules.ModuleRTAntenna");
                    ModuleRTAntennaConsumptionMultiplier = ModuleRTAntennaType
                        .GetProperty("ConsumptionMultiplier", BindingFlags.Instance | BindingFlags.NonPublic)
                        .GetGetMethod(true);
                    ...
                    {
                        Lib.Log(
                            "RemoteTech version is below v1.9 - Kerbalism's signal system will not operate correctly with the version" +
                            " of RemoteTech currently installed." + Environment.NewLine +
                            "Please update your installation of RemoteTech to the latest version.",
        ...
        {
            return (float) ModuleRTAntennaConsumptionMultiplier.Invoke(moduleRTAntenna, null) *
                   (float) ModuleRTAntennaEnergyCost.GetValue(moduleRTAntenna);
        }
