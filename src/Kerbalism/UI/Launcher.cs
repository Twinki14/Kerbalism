...
namespace Kerbalism
{
    public sealed class Launcher
    {
        ...
        private const ControlTypes MainGUILockTypes =
        ...
        public void Create()
        {
            ...
            if (!ui_initialized)
            {
                ...
                vesselListLauncher = ApplicationLauncher.Instance.AddApplication(null, null, null, null, null, null,
                    Textures.applauncher_vessels);
            ...
            if (Features.Science)
            {
                ...
                {
                    generalMenuLauncher = ApplicationLauncher.Instance.AddApplication(null, null, null, null, null,
                        null, Textures.applauncher_database);
        ...
        public void On_gui()
        {
            ...
            // render the window
            if (vesselListLauncher.toggleButton.Value || vesselListLauncher.IsHovering ||
                (win_rect.width > 0f && win_rect.Contains(Mouse.screenPos)))
            {
                // hard-coded offsets
