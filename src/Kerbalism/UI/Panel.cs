...
namespace Kerbalism
{
    ...
    public sealed class Panel
    {
        ...
        public void AddContent(string label, string value = "", string tooltip = "", Action click = null,
            Action hover = null)
        {
            Entry e = new Entry
            {
