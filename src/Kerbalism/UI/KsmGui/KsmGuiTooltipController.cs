...
namespace Kerbalism.KsmGui
{
    public class KsmGuiTooltipController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            TopTransform.sizeDelta =
                new Vector2(KsmGuiStyle.tooltipMaxWidth, 0f); // max width of tooltip, text wrap will occur if larger.
        ...
        private void Update()
        {
            if (IsVisible)
            {
                ...
                RectTransformUtility.ScreenPointToWorldPointInRectangle(TopTransform, Input.mousePosition,
                    UIMasterController.Instance.uiCamera, out mouseWorldPos);
