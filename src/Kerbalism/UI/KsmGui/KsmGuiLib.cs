...
namespace Kerbalism.KsmGui
{
    public static class KsmGuiLib
    {
        ...
        public static void SetAnchorsAndPosition(this RectTransform transform, TextAnchor originInParent,
            TextAnchor destinationPivot, int deltaX = 0, int deltaY = 0)
        {
            ...
            switch (originInParent)
            {
                ...
                case TextAnchor.MiddleLeft:
                    ...
                    transform.anchorMax = new Vector2(0.0f, 0.5f);
                    break;
        ...
        public static void AddImageComponentWithColor(this KsmGuiBase ksmGuiBase, Color color)
        {
            ...
            if (ksmGuiBase.TopObject.GetComponent<Graphic>() != null)
                Lib.Log(
                    "KsmGui error : can't add a background color to " + ksmGuiBase.Name +
                    ", the GameObject already has a graphic component", Lib.LogLevel.Warning);
