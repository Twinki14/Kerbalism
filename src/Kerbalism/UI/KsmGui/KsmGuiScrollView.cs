...
namespace Kerbalism.KsmGui
{
    public class KsmGuiVerticalScrollView : KsmGuiBase
    {
        ...
        public KsmGuiVerticalScrollView(KsmGuiBase parent, int contentSpacing = 5, int contentPaddingLeft = 5,
            int contentPaddingRight = 5, int contentPaddingTop = 5, int contentPaddingBottom = 5) : base(parent)
        {
            ...
            ContentGroup.padding = new RectOffset(contentPaddingLeft, contentPaddingRight, contentPaddingTop,
