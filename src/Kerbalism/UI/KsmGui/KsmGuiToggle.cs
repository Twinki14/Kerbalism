...
namespace Kerbalism.KsmGui
{
    public class KsmGuiToggle : KsmGuiHorizontalLayout, IKsmGuiText, IKsmGuiInteractable
    {
        ...
        public KsmGuiToggle(KsmGuiBase parent, string toggleText, bool initialOnState, UnityAction<bool> onClick,
            string tooltipText = null, int width = -1, int height = 18)
            : base(parent, 5)
        {
            ...
            ToggleComponent.navigation =
                new Navigation() {mode = Navigation.Mode.None}; // fix the transitions getting stuck
            ...
            TextObject = new KsmGuiText(this, toggleText, null, TextAlignmentOptions.Left, false,
