...
namespace Kerbalism
{
    ...
    internal static class Textures
    {
        ...
        internal static Sprite Get9SlicesSprite(string textureName, int width, int height, int borderSize)
        {
            ...
            return Sprite.Create(tex, new Rect(0f, 0f, width, height), new Vector2(0.5f, 0.5f), 100f, 0u,
                SpriteMeshType.Tight, new Vector4(borderSize, borderSize, borderSize, borderSize));
        }
