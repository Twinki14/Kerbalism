    ...
    public static class Styles
    {
        static Styles()
        {
            ...
            message = new GUIStyle()
            {
                ...
                alignment = TextAnchor.MiddleCenter,
                border = new RectOffset(0, 0, 0, 0),
                padding = new RectOffset(Styles.ScaleInteger(2), Styles.ScaleInteger(2), Styles.ScaleInteger(2),
                    Styles.ScaleInteger(2))
            };
        }
        ...
        {
            return (uint) ScaleWidthFloat(val / (Settings.UIScale * Settings.UIScale * GameSettings.UI_SCALE *
        ...
        public static Texture2D GetUIScaledTexture(string name, int width = 16, int height = 16, float prescalar = 1.0f)
        {
            ...
            Lib.ScaleTexture(texture, ScaleInteger((int) (texture.width / prescalar)),
                ScaleInteger((int) (texture.height / prescalar)));
