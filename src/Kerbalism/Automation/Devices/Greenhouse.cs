...
namespace Kerbalism.Automation.Devices
{
    public sealed class GreenhouseDevice : LoadedDevice<Greenhouse>
    {
        ...
        public override string Status => Lib.Color(module.active, Local.Generic_ENABLED, Lib.Kolor.Green,
    ...
    {
        public ProtoGreenhouseDevice(Greenhouse prefab, ProtoPartSnapshot protoPart,
            ProtoPartModuleSnapshot protoModule)
            : base(prefab, protoPart, protoModule)
        {
        }

        public override string Status => Lib.Color(Lib.Proto.GetBool(protoModule, "active"), Local.Generic_ENABLED,
