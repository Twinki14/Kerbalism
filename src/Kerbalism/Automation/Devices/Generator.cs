namespace Kerbalism.Automation.Devices
{
    public sealed class GeneratorDevice : LoadedDevice<ModuleGenerator>
    {
        ...
        public override string Status
            => module.isAlwaysActive
                ? Local.Generic_ALWAYSON
                : Lib.Color(module.generatorIsActive, Local.Generic_ON, Lib.Kolor.Green, Local.Generic_OFF,
                    Lib.Kolor.Yellow);
    ...
    {
        public ProtoGeneratorDevice(ModuleGenerator prefab, ProtoPartSnapshot protoPart,
