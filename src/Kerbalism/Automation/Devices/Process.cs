...
namespace Kerbalism.Automation.Devices
{
    public sealed class ProcessDevice : LoadedDevice<ProcessController>
    {
        ...
        public override string Tooltip =>
            Lib.BuildString(base.Tooltip, "\n", Lib.Bold("Process capacity :"), "\n", module.ModuleInfo);

        public override string Status => Lib.Color(module.IsRunning(), Local.Generic_RUNNING, Lib.Kolor.Green,
    ...
    {
        public ProtoProcessDevice(ProcessController prefab, ProtoPartSnapshot protoPart,
        ...
        public override string Status => Lib.Color(Lib.Proto.GetBool(protoModule, "running"), Local.Generic_RUNNING,
            Lib.Kolor.Green, Local.Generic_STOPPED, Lib.Kolor.Yellow);
