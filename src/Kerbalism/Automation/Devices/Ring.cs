...
namespace Kerbalism.Automation.Devices
{
    public sealed class RingDevice : LoadedDevice<GravityRing>
    {
        ...
        public override string Status => Lib.Color(module.deployed, Local.Generic_DEPLOYED, Lib.Kolor.Green,
            Local.Generic_RETRACTED, Lib.Kolor.Yellow);
    ...
    public sealed class ProtoRingDevice : ProtoDevice<GravityRing>
    {
        ...
        public override string Status => Lib.Color(Lib.Proto.GetBool(protoModule, "deployed"), Local.Generic_DEPLOYED,
            Lib.Kolor.Green, Local.Generic_RETRACTED, Lib.Kolor.Yellow);
