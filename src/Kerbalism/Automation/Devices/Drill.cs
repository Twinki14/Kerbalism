namespace Kerbalism.Automation.Devices
{
    public sealed class DrillDevice : LoadedDevice<ModuleResourceHarvester>
    {
        ...
        public override string Status
        {
            get
            {
                ...
                return Lib.Color(module.IsActivated, Local.Generic_ON, Lib.Kolor.Green, Local.Generic_OFF,
                    Lib.Kolor.Yellow);
            }
        }
    ...
    {
        public ProtoDrillDevice(ModuleResourceHarvester prefab, ProtoPartSnapshot protoPart,
