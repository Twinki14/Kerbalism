...
namespace Kerbalism.Database
{
    public class ReliabilityInfo
    {
        ...
        public ReliabilityInfo(Reliability module)
        {
            ...
            {
                rel_duration = module.operation_duration /
                               Reliability.EffectiveDuration(module.quality, module.rated_operation_duration);
                rel_duration = Lib.Clamp(rel_duration, 0, 1);
            }

            if (module.rated_ignitions > 0)
            {
                rel_ignitions = (double) module.ignitions /
                                Reliability.EffectiveIgnitions(module.quality, module.rated_ignitions);
        ...
        public ReliabilityInfo(ProtoPartSnapshot p, ProtoPartModuleSnapshot m, Reliability module_prefab)
        {
            ...
            if (module_prefab.rated_operation_duration > 0)
            {
                ...
                rel_duration = operation_duration /
                               Reliability.EffectiveDuration(quality, module_prefab.rated_operation_duration);
                rel_duration = Lib.Clamp(rel_duration, 0, 1);
            }
            ...
            if (module_prefab.rated_ignitions > 0)
            {
                ...
                rel_ignitions = (double) ignitions /
                                Reliability.EffectiveDuration(quality, module_prefab.rated_ignitions);
                rel_ignitions = Lib.Clamp(rel_ignitions, 0, 1);
            }
