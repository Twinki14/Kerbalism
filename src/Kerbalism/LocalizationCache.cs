...
namespace Kerbalism
{
    public static class LocalHelpers
    {
        ...
        private const string PathToLocalizationCache =
            @"C:\Users\Got\source\repos\Kerbalism\Kerbalism\src\Kerbalism\LocalizationCache.cs";
        ...
        private const string PathToExistingNonEnglishLoc =
            @"C:\Users\Got\source\repos\Kerbalism\Kerbalism\GameData\Kerbalism\Localization\" + locLanguage + ".cfg";
        ...
        {
            string[] localCachelines = global::System.IO.File.ReadAllLines(PathToLocalizationCache);
            ...
            foreach (string line in localCachelines)
            {
                ...
                if (locMatch.Success)
                {
                    if (!template)
                        ...
                        locFile.Add("    #KERBALISM_" + locMatch.Groups[1].Value + " = " + "// \"" +
                                    locMatch.Groups[2].Value + "\"");
                ...
                {
                    if (!template)
                        locFile.Add("    #KERBALISM_" + parameterLocMatch.Groups[1].Value + " = " +
                                    parameterLocMatch.Groups[2].Value);
                    else
                        locFile.Add("    #KERBALISM_" + parameterLocMatch.Groups[1].Value + " = " + "// \"" +
                                    parameterLocMatch.Groups[2].Value + "\"");
                    continue;
            ...
            global::System.IO.File.WriteAllLines(PathToEnglishLocOutput, locFile.ToArray());
        }

        public static void RegenerateNonEnglishLoc()
        {
            string[] existingLocLines = global::System.IO.File.ReadAllLines(PathToExistingNonEnglishLoc);
            ...
            string[] englishLocLines = global::System.IO.File.ReadAllLines(PathToLocalizationCache);
            ...
            global::System.IO.File.WriteAllLines(PathToNonEnglishLocOutput, outputLoc.ToArray());
        }
    }
    ...
    public static class Local
    {
        ...
        static Local()
        {
            ...
            MethodInfo replaceTagsInfo = locInstance.GetType().GetMethod("ReplaceTags",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
            ReplaceTags = (Func<string[], List<string>>) Delegate.CreateDelegate(typeof(Func<string[], List<string>>),
                locInstance, replaceTagsInfo);
        }
        ...
        public static string
            Contracts_radDesc =
                GetLoc("Contracts_radDesc"); // "A brilliant scientist predicted two belts of super-charged particles surrounding the planet. Now we need to confirm their existence and find out how deadly they really are."

        public static string
            Contracts_radComplete =
                GetLoc("Contracts_radComplete"); // "The mission confirmed the presence of two radiation belts around the planet. Early data suggest extreme levels of radiation."

        public static string Contracts_heliopauseTitle = GetLoc("Contracts_heliopauseTitle"); // "Cross the heliopause"

        public static string
            Contracts_heliopauseDesc =
                GetLoc("Contracts_heliopauseDesc"); // "What is out there, beyond the heliopause? The truth is, we don't know. That's where you come in."
        ...
        public static string
            Contracts_sampleDesc =
                GetLoc("Contracts_sampleDesc"); // "The Laboratory can analyze samples in space, in theory. We should check if this actually work by and analyzing some samples in space."

        public static string
            Contracts_sampleComplete =
                GetLoc("Contracts_sampleComplete"); // "Our Laboratory analysis was good, perhaps even better than the ones done usually by our scientists at mission control. But don't tell'em."

        ////////////////////////////////////////////////////////////////////
        // Body info UI
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            BodyInfo_BodyInfoToggleHelp =
                new ParamString("BodyInfo_BodyInfoToggleHelp"); // "Press <<1>> to open this window again"
        ...
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            Monitor_GoComfirm = new ParamString("Monitor_GoComfirm"); // "Do you really want go to <<1>> vessel?"
        ...
        public static string
            DevManager_TabManual = GetLoc("DevManager_TabManual"); // "<i>Control vessel components directly</i>"

        public static string DevManager_TabLanded = GetLoc("DevManager_TabLanded"); // "<i>Called on landing</i>"

        public static string
            DevManager_TabAtmo = GetLoc("DevManager_TabAtmo"); // "<i>Called on entering atmosphere</i>"

        public static string DevManager_TabSpace = GetLoc("DevManager_TabSpace"); // "<i>Called on reaching space</i>"

        public static string
            DevManager_TabSunlight = GetLoc("DevManager_TabSunlight"); // "<i>Called when sun became visible</i>"

        public static string
            DevManager_TabShadow = GetLoc("DevManager_TabShadow"); // "<i>Called when sun became occluded</i>"

        public static string
            DevManager_TabPowerHigh = GetLoc("DevManager_TabPowerHigh"); // "<i>Called when EC level goes above 80%</i>"

        public static string
            DevManager_TabPowerLow = GetLoc("DevManager_TabPowerLow"); // "<i>Called when EC level goes below 20%</i>"

        public static string
            DevManager_TabRadHigh = GetLoc("DevManager_TabRadHigh"); // "<i>Called when radiation exceed 0.05 rad/h</i>"

        public static string
            DevManager_TabRadLow =
                GetLoc("DevManager_TabRadLow"); // "<i>Called when radiation goes below 0.02 rad/h</i>"

        public static string
            DevManager_TabLinked = GetLoc("DevManager_TabLinked"); // "<i>Called when signal is regained</i>"

        public static string
            DevManager_TabUnlinked = GetLoc("DevManager_TabUnlinked"); // "<i>Called when signal is lost</i>"

        public static string
            DevManager_TabEVAOut = GetLoc("DevManager_TabEVAOut"); // "<i>Called when going out on EVA</i>"

        public static string
            DevManager_TabEVAIn = GetLoc("DevManager_TabEVAIn"); // "<i>Called when returning from EVA</i>"

        public static string
            DevManager_TabAct1 = GetLoc("DevManager_TabAct1"); // "<i>Called by pressing <b>1</b> on the keyboard</i>"

        public static string
            DevManager_TabAct2 = GetLoc("DevManager_TabAct2"); // "<i>Called by pressing <b>2</b> on the keyboard</i>"

        public static string
            DevManager_TabAct3 = GetLoc("DevManager_TabAct3"); // "<i>Called by pressing <b>3</b> on the keyboard</i>"

        public static string
            DevManager_TabAct4 = GetLoc("DevManager_TabAct4"); // "<i>Called by pressing <b>4</b> on the keyboard</i>"

        public static string
            DevManager_TabAct5 = GetLoc("DevManager_TabAct5"); // "<i>Called by pressing <b>5</b> on the keyboard</i>"

        public static string
            DevManager_TabDriveFull =
                GetLoc("DevManager_TabDriveFull"); // "<i>Called when data free space is below 10%</i>"

        public static string
            DevManager_TabDriveEmpty =
                GetLoc("DevManager_TabDriveEmpty"); // "<i>Called when data free space is above 85%</i>"
        ...
        public static string
            Configure_dumpexcess =
                GetLoc("Configure_dumpexcess"); // "Reconfiguring will dump resources in excess of capacity."

        public static string Science_ofdatatransfer = GetLoc("Science_ofdatatransfer"); // "of data transfered"

        public static string
            Science_inoperable =
                GetLoc("Science_inoperable"); // "The experiment is now inoperable, resetting will require a <b>Scientist</b>"
        ...
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            FILEMANAGER_DataAvailable = new ParamString("FILEMANAGER_DataAvailable"); // "(<<1>> available)"

        public static ParamString
            FILEMANAGER_SAMPLESMass = new ParamString("FILEMANAGER_SAMPLESMass"); // "SAMPLES <<1>>"

        public static ParamString
            FILEMANAGER_TransmittingRate = new ParamString("FILEMANAGER_TransmittingRate"); // "Transmitting at <<1>>"

        public static ParamString
            FILEMANAGER_DeleteConfirm =
                new ParamString("FILEMANAGER_DeleteConfirm"); // "Do you really want to delete <<1>>?"

        public static ParamString
            FILEMANAGER_DumpConfirm = new ParamString("FILEMANAGER_DumpConfirm"); // "Do you really want to dump <<1>>?"
        ...
        public static string
            FILEMANAGER_Transmitduration = GetLoc("FILEMANAGER_Transmitduration"); // "Transmit duration :"

        public static string
            FILEMANAGER_send = GetLoc("FILEMANAGER_send"); // "Flag the file for transmission to <b>DSN</b>"
        ...
        public static string
            FILEMANAGER_DeleteConfirm_button1 = GetLoc("FILEMANAGER_DeleteConfirm_button1"); // "Delete it"

        public static string
            FILEMANAGER_DeleteConfirm_button2 = GetLoc("FILEMANAGER_DeleteConfirm_button2"); // "Keep it"

        public static string
            FILEMANAGER_analysis =
        ...
        public static string
            TELEMETRY_SolarPanelsAverageExposure =
                GetLoc("TELEMETRY_SolarPanelsAverageExposure"); // "solar panels average exposure"

        public static string TELEMETRY_Exposureignoringbodiesocclusion =
            GetLoc("TELEMETRY_Exposureignoringbodiesocclusion"); // "Exposure ignoring bodies occlusion"

        public static string TELEMETRY_Exposureignoringbodiesocclusion_desc =
            GetLoc(
                "TELEMETRY_Exposureignoringbodiesocclusion_desc"); // "Won't change on unloaded vessels\nMake sure to optimize it before switching"

        public static string
            TELEMETRY_nosensorsinstalled = GetLoc("TELEMETRY_nosensorsinstalled"); // "no sensors installed"
        ...
        public static string
            TELEMETRY_maxtransmissionrate = GetLoc("TELEMETRY_maxtransmissionrate"); // "max transmission rate"

        public static string TELEMETRY_target = GetLoc("TELEMETRY_target"); // "target"

        public static string
            TELEMETRY_totalsciencetransmitted =
                GetLoc("TELEMETRY_totalsciencetransmitted"); // "total science transmitted"
        ...
        public static string
            VESSELCONFIG_Highlightfailed = GetLoc("VESSELCONFIG_Highlightfailed"); // "highlight malfunctions"

        public static string
            VESSELCONFIG_Highlightfailed_desc =
                GetLoc("VESSELCONFIG_Highlightfailed_desc"); // "Highlight failed components"

        public static string VESSELCONFIG_MESSAGES = GetLoc("VESSELCONFIG_MESSAGES"); // "MESSAGES"

        public static string
            VESSELCONFIG_EClow = GetLoc("VESSELCONFIG_EClow"); // "Receive a message when\nElectricCharge level is low"

        public static string VESSELCONFIG_battery = GetLoc("VESSELCONFIG_battery"); // "battery"

        public static string
            VESSELCONFIG_Supplylow =
                GetLoc("VESSELCONFIG_Supplylow"); // "Receive a message when\nsupply resources level is low"

        public static string VESSELCONFIG_supply = GetLoc("VESSELCONFIG_supply"); // "supply"

        public static string
            VESSELCONFIG_Signallost =
        ...
        public static string
            VESSELCONFIG_ShowVessel_desc =
                GetLoc("VESSELCONFIG_ShowVessel_desc"); // "Show this vessel in the vessels list"
        ...
        public static string
            SCIENCEARCHIVE_hidearchive = GetLoc("SCIENCEARCHIVE_hidearchive"); // "hide science archive"
        ...
        public static string
            SCIENCEARCHIVE_EXPERIMENTINFO = GetLoc("SCIENCEARCHIVE_EXPERIMENTINFO"); // "EXPERIMENT INFO"
        ...
        public static string
            SCIENCEARCHIVE_showarchive = GetLoc("SCIENCEARCHIVE_showarchive"); // "show science archive"

        public static string
            SCIENCEARCHIVE_showexperimentinfo = GetLoc("SCIENCEARCHIVE_showexperimentinfo"); // "show experiment info"

        public static string
            SCIENCEARCHIVE_hideexperimentinfo = GetLoc("SCIENCEARCHIVE_hideexperimentinfo"); // "hide experiment info"
        ...
        public static string
            SCIENCEARCHIVE_forcedrun_desc =
                GetLoc("SCIENCEARCHIVE_forcedrun_desc"); // "force experiment to run even\nif there is no science value left"
        ...
        public static string
            SCIENCEARCHIVE_invalidsituation = GetLoc("SCIENCEARCHIVE_invalidsituation"); // "invalid situation"
        ...
        public static string
            SCIENCEARCHIVE_Showonlyknownsubjects =
                GetLoc("SCIENCEARCHIVE_Showonlyknownsubjects"); // "Show only known subjects"

        public static string SCIENCEARCHIVE_RnD = GetLoc("SCIENCEARCHIVE_RnD"); // "RnD"

        public static string
            SCIENCEARCHIVE_RnD_desc = GetLoc("SCIENCEARCHIVE_RnD_desc"); // "Science points\nretrieved in RnD"

        public static string SCIENCEARCHIVE_Flight = GetLoc("SCIENCEARCHIVE_Flight"); // "Flight"

        public static string
            SCIENCEARCHIVE_Flight_desc =
                GetLoc("SCIENCEARCHIVE_Flight_desc"); // "Science points\ncollected in all vessels"

        public static string SCIENCEARCHIVE_Value = GetLoc("SCIENCEARCHIVE_Value"); // "Value"

        public static string
            SCIENCEARCHIVE_Value_desc =
                GetLoc("SCIENCEARCHIVE_Value_desc"); // "Remaining science value\naccounting for data retrieved in RnD\nand collected in flight"

        public static string SCIENCEARCHIVE_Completed = GetLoc("SCIENCEARCHIVE_Completed"); // "Completed"

        public static string
            SCIENCEARCHIVE_Completed_desc =
                GetLoc("SCIENCEARCHIVE_Completed_desc"); // "How many times the subject\nhas been retrieved in RnD"
        ...
        // Module : Experiment
        ////////////////////////////////////////////////////////////////////
        public static ParamString Module_Experiment_MultipleRunsMessage =
            new ParamString(
                "Module_Experiment_MultipleRunsMessage"); // "Can't start <<1>> a second time on vessel <<2>>"
        ...
        public static ParamString
            Module_Experiment_issue12 = new ParamString("Module_Experiment_issue12"); // "missing <<1>>"
        ...
        public static string
            Module_Experiment_runningstate3 = GetLoc("Module_Experiment_runningstate3"); // "forced run"
        ...
        public static string
            Module_Experiment_ScienceValuenone = GetLoc("Module_Experiment_ScienceValuenone"); // "none"

        public static string Module_Experiment_Requires = GetLoc("Module_Experiment_Requires"); // "Requires:"

        public static string
            Module_Experiment_Specifics_info1 = GetLoc("Module_Experiment_Specifics_info1"); // "Data size"

        public static string
            Module_Experiment_Specifics_info2 = GetLoc("Module_Experiment_Specifics_info2"); // "Data rate"

        public static string
            Module_Experiment_Specifics_info3 = GetLoc("Module_Experiment_Specifics_info3"); // "Duration"

        public static string
            Module_Experiment_Specifics_info4 = GetLoc("Module_Experiment_Specifics_info4"); // "Sample size"

        public static string
            Module_Experiment_Specifics_info5 = GetLoc("Module_Experiment_Specifics_info5"); // "Sample mass"

        public static string
            Module_Experiment_Specifics_info6 = GetLoc("Module_Experiment_Specifics_info6"); // "Samples"

        public static string Module_Experiment_Specifics_info7_sample =
            GetLoc("Module_Experiment_Specifics_info7_sample"); // "Duration"

        public static string
            Module_Experiment_Specifics_Situations = GetLoc("Module_Experiment_Specifics_Situations"); // "Situations:"

        public static string
            Module_Experiment_Specifics_info8 = GetLoc("Module_Experiment_Specifics_info8"); // "Needs:"

        public static string Module_Experiment_Specifics_info9 = GetLoc("Module_Experiment_Specifics_info9"); // "EC"

        public static string
            Module_Experiment_Specifics_info10 = GetLoc("Module_Experiment_Specifics_info10"); // "Preparation"

        public static string Module_Experiment_Specifics_info10_none =
            GetLoc("Module_Experiment_Specifics_info10_none"); // "none"

        public static string
            Module_Experiment_Specifics_info11 = GetLoc("Module_Experiment_Specifics_info11"); // "Operation"

        public static string Module_Experiment_Specifics_info11_unmanned =
            GetLoc("Module_Experiment_Specifics_info11_unmanned"); // "unmanned"

        public static string
            Module_Experiment_Specifics_info12 = GetLoc("Module_Experiment_Specifics_info12"); // "Reset"

        public static string Module_Experiment_Specifics_info12_none =
        ...
        public static string
            Module_Experiment_Message2 = GetLoc("Module_Experiment_Message2"); // "I will not even know where to start"

        public static string
            Module_Experiment_Message3 = GetLoc("Module_Experiment_Message3"); // "I'm afraid I can't do that"

        public static string
            Module_Experiment_Message4 = GetLoc("Module_Experiment_Message4"); // "Preparation Complete"

        public static string Module_Experiment_Message5 = GetLoc("Module_Experiment_Message5"); // "Ready to go"

        public static string
            Module_Experiment_Message6 = GetLoc("Module_Experiment_Message6"); // "Let's start doing some science!"

        public static string Module_Experiment_Message7 = GetLoc("Module_Experiment_Message7"); // "Reset Done"

        public static string
            Module_Experiment_Message8 = GetLoc("Module_Experiment_Message8"); // "It's good to go again"
        ...
        public static string
            HardDrive_WARNING_title = GetLoc("HardDrive_WARNING_title"); // "WARNING: not evering copied"
        ...
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            Scansat_Scannerhalted_text =
                new ParamString("Scansat_Scannerhalted_text"); // "Scanner halted on <<1>>. No storage left on vessel."

        public static ParamString
            Scansat_sensorresumed =
                new ParamString("Scansat_sensorresumed"); // "SCANsat sensor resumed operations on <<1>>"

        public static ParamString
            Scansat_sensordisabled =
                new ParamString("Scansat_sensordisabled"); // "SCANsat sensor was disabled on <<1>>"
        ...
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            Laboratory_Analyzed = new ParamString("Laboratory_Analyzed"); // "Our laboratory on <<1>> analyzed <<2>>"
        ...
        public static string
            Laboratory_Cleaned = GetLoc("Laboratory_Cleaned"); // "Vessel experiments have been cleaned."

        public static string
            Laboratory_Specs = GetLoc("Laboratory_Specs"); // "Analyze samples to produce transmissible data"
        ...
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            Sensor_insideatmosphere = new ParamString("Sensor_insideatmosphere"); // "inside <b>atmosphere</b>(<<1>>)"

        public static string
            Sensor_info = GetLoc("Sensor_info"); // "Add telemetry readings to the part ui, and to the telemetry panel"
        ...
        public static string
            Sensor_insidethermosphere = GetLoc("Sensor_insidethermosphere"); // "inside <b>thermosphere</b>"

        public static string Sensor_insideexosphere = GetLoc("Sensor_insideexosphere"); // "inside <b>exosphere</b>"

        public static string
            Sensor_Graviolidetection = GetLoc("Sensor_Graviolidetection"); // "Gravioli detection events per-year: "

        public static string
            Sensor_info1 =
                GetLoc("Sensor_info1"); // "The elusive negative gravioli particle\nseems to be much harder to detect than expected."
        ...
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            SolarPanelFixer_occludedby = new ParamString("SolarPanelFixer_occludedby"); // "occluded by <<1>>"

        public static string SolarPanelFixer_Solarpanel = GetLoc("SolarPanelFixer_Solarpanel"); // "Solar panel"

        public static string
            SolarPanelFixer_Solarpaneloutput = GetLoc("SolarPanelFixer_Solarpaneloutput"); // "Solar panel output"

        public static string
            SolarPanelFixer_simulated = GetLoc("SolarPanelFixer_simulated"); // "<color=#00ff00>simulated</color>"

        public static string
            SolarPanelFixer_ignored = GetLoc("SolarPanelFixer_ignored"); // "<color=#ffff00>ignored</color>"

        public static string SolarPanelFixer_inshadow = GetLoc("SolarPanelFixer_inshadow"); // "in shadow"

        public static string
            SolarPanelFixer_occludedbyterrain = GetLoc("SolarPanelFixer_occludedbyterrain"); // "occluded by terrain"

        public static string
            SolarPanelFixer_badorientation = GetLoc("SolarPanelFixer_badorientation"); // "bad orientation"
        ...
        public static string
            SolarPanelFixer_Selecttrackedstar = GetLoc("SolarPanelFixer_Selecttrackedstar"); // "Select tracked star"

        public static string
            SolarPanelFixer_SelectTrackingBody = GetLoc("SolarPanelFixer_SelectTrackingBody"); // "SelectTrackingBody"

        public static string
            SolarPanelFixer_SelectTrackedstar_msg =
                GetLoc(
        ...
        ////////////////////////////////////////////////////////////////////
        public static ParamString
            CallBackMsg_EvaNoMP = new ParamString("CallBackMsg_EvaNoMP"); // "There isn't any <<1>> in the EVA suit"
        ...
        public static string
            CallBackMsg_PROGRESS2 = GetLoc("CallBackMsg_PROGRESS2"); // "Our scientists just made a breakthrough"
        ...
        public static string
            TransmitScienceImmediately = GetLoc("TransmitScienceImmediately"); // "Transmit Science Immediately"

        public static string
            TransmitScienceImmediately_desc =
                GetLoc("TransmitScienceImmediately_desc"); // "Automatically flag science files for transmission"

        public static string
            AnalyzeSamplesImmediately = GetLoc("AnalyzeSamplesImmediately"); // "Analyze Samples Immediately"

        public static string
            AnalyzeSamplesImmediately_desc =
                GetLoc("AnalyzeSamplesImmediately_desc"); // "Automatically flag samples for analysis in a lab"
        ...
        public static string
            Alwaysallowsampletransfers = GetLoc("Alwaysallowsampletransfers"); // "Always allow sample transfers"

        public static string
            Alwaysallowsampletransfers_desc =
                GetLoc("Alwaysallowsampletransfers_desc"); // "When off, sample transfer is only available in crewed vessels"
        ...
        public static string
            ElectricalCharge_desc =
                GetLoc("ElectricalCharge_desc"); // "Show a message when EC level is low\n(Preset, can be changed per vessel)"

        public static string Supplies = GetLoc("Supplies"); // "Supplies"

        public static string
            Supplies_desc =
                GetLoc("Supplies_desc"); // "Show a message when supply resources level is low\n(Preset, can be changed per vessel)"
        ...
        public static string
            Scripts_desc =
                GetLoc("Scripts_desc"); // "Show a message when scripts are executed\n(Preset, can be changed per vessel)"

        public static string StockMessages = GetLoc("StockMessages"); // "Stock Messages"

        public static string
            StockMessages_desc = GetLoc("StockMessages_desc"); // "Use the stock message system instead of our own"
        ...
        public static string
            Planner_SunlightNominal =
                GetLoc("Planner_SunlightNominal"); // "In sunlight\n<b>Nominal</b> solar panel output"

        public static string
            Planner_SunlightSimulated =
                GetLoc("Planner_SunlightSimulated"); // "In sunlight\n<b>Estimated</b> solar panel output\n<i>Sunlight direction : look at the shadows !</i>"
        ...
        public static string
            Planner_RenderQuote =
                GetLoc("Planner_RenderQuote"); // "In preparing for space, I have always found that\nplans are useless but planning is indispensable.\nWernher von Kerman"
        ...
        public static string
            Planner_difference_desc =
                GetLoc("Planner_difference_desc"); // "difference between external and survival temperature"
        ...
        public static string
            Planner_shadowtime_desc = GetLoc("Planner_shadowtime_desc"); // "the time in shadow\nduring the orbit"
        ...
        public static string
            Planner_analyzerpressurized1 =
                GetLoc("Planner_analyzerpressurized1"); // "Free roaming in a pressurized environment is\nvastly superior to living in a suit."

        public static string
            Planner_analyzerpressurized2 =
                GetLoc("Planner_analyzerpressurized2"); // "Being forced inside a suit all the time greatly\nreduces the crews quality of life.\nThe worst part is the diaper."
        ...
        public static string
            Experimentinfo_generatesample = GetLoc("Experimentinfo_generatesample"); // "Will generate a sample."
        ...
        public static string
            Experimentinfo_Asteroid =
                GetLoc("Experimentinfo_Asteroid"); // "Asteroid samples can be taken by kerbals on EVA"

        public static string
            Experimentinfo_scannerarm = GetLoc("Experimentinfo_scannerarm"); // "Analyse with a scanner arm"

        public static string
            Experimentinfo_smallRoc = GetLoc("Experimentinfo_smallRoc"); // "Collectable on EVA as a sample"

        public static string
            Experimentinfo_smallRoc2 = GetLoc("Experimentinfo_smallRoc2"); // "Can't be collected on EVA"

        public static ParamString
            Experimentinfo_smallRoc3 = new ParamString("Experimentinfo_smallRoc3"); // "Found on <<1>>'s :"

        public static string Experimentinfo_Bodiesallowed = GetLoc("Experimentinfo_Bodiesallowed"); // "Bodies allowed:"

        public static string
            Experimentinfo_Bodiesnotallowed = GetLoc("Experimentinfo_Bodiesnotallowed"); // "Bodies not allowed:"

        public static string Experimentinfo_BodyCondition1 = GetLoc("Experimentinfo_BodyCondition1"); // "atmospheric"

        public static string
            Experimentinfo_BodyCondition2 = GetLoc("Experimentinfo_BodyCondition2"); // "non-atmospheric"
        ...
        public static string
            Experimentinfo_BodyCondition7 = GetLoc("Experimentinfo_BodyCondition7"); // "home body and its moons"
        ...
        public static ParamString
            BeltWarnings_msg = new ParamString("BeltWarnings_msg"); // "<<1>> is crossing <<2>> radiation belt"

        // Remove Symmetry On Visible Resource Switch
        public static ParamString
            RemoveSymmetry_msg =
                new ParamString(
                    "RemoveSymmetry_msg"); // "Symmetry on <<1>>\nhas been removed because of switching the <<2>> capacity."

        // Notify the user when crop can be harvested
        public static ParamString
            harvestedready_msg = new ParamString("harvestedready_msg"); // "On <<1>> the crop is ready to be harvested"

        public static string
            BeltWarnings_msgSubtext = GetLoc("BeltWarnings_msgSubtext"); // "Exposed to extreme radiation"

        public static string
            Fittingparticles_msg = GetLoc("Fittingparticles_msg"); // "Fitting particles to signed distance fields"
        ...
        public static string
            Kerbalmumbling = GetLoc("Kerbalmumbling"); // "$ON_VESSEL$KERBAL has been in space for too long"

        public static string Kerbalmumbling_subtext = GetLoc("Kerbalmumbling_subtext"); // "Mumbling incoherently"

        public static string
            Kerbalfatfinger =
                GetLoc("Kerbalfatfinger"); // "$ON_VESSEL$KERBAL is pressing buttons at random on the control panel"

        public static string
            Kerbalfatfinger_subtext = GetLoc("Kerbalfatfinger_subtext"); // "Science data has been lost"
        ...
        public static string
            Kerbalwrongvalve = GetLoc("Kerbalwrongvalve"); // "$ON_VESSEL$KERBAL opened the wrong valve"

        public static string
            Kerbalwrongvalve_subtext =
                GetLoc("Kerbalwrongvalve_subtext"); // "has been lost" //eg.[Resource Name] has been lost
        ...
        public static string
            SciencresultText1 = GetLoc("SciencresultText1"); // "Our researchers will jump on it right now"

        public static string SciencresultText2 = GetLoc("SciencresultText2"); // "This cause some excitement"

        public static string
            SciencresultText3 = GetLoc("SciencresultText3"); // "These results are causing a brouhaha in R&D"

        public static string SciencresultText4 = GetLoc("SciencresultText4"); // "Our scientists look very confused"

        public static string
            SciencresultText5 = GetLoc("SciencresultText5"); // "The scientists won't believe these readings"
        ...
        public static string
            Situation_NorthernHemisphere = GetLoc("Situation_NorthernHemisphere"); // "north hemisphere"
        ...
        //Flight Logger
        public static ParamString
            FlightLogger_MaterialFatigue =
                new ParamString("FlightLogger_MaterialFatigue"); // "<<1>> failed because of material fatigue"

        public static ParamString
            FlightLogger_Destruction =
                new ParamString(
                    "FlightLogger_Destruction"); // "<<1>> fuel system leak caused destruction of the engine"

        public static ParamString
            FlightLogger_Ignition = new ParamString("FlightLogger_Ignition"); // "<<1>> failure on ignition"

        //Experiment required
        public static string
            ExperimentReq_OrbitMinInclination = GetLoc("ExperimentReq_OrbitMinInclination"); // "Min. inclination "

        public static string
            ExperimentReq_OrbitMaxInclination = GetLoc("ExperimentReq_OrbitMaxInclination"); // "Max. inclination "

        public static string
            ExperimentReq_OrbitMinEccentricity = GetLoc("ExperimentReq_OrbitMinEccentricity"); // "Min. eccentricity "

        public static string
            ExperimentReq_OrbitMaxEccentricity = GetLoc("ExperimentReq_OrbitMaxEccentricity"); // "Max. eccentricity "

        public static string
            ExperimentReq_OrbitMinArgOfPeriapsis =
                GetLoc("ExperimentReq_OrbitMinArgOfPeriapsis"); // "Min. argument of Pe "

        public static string
            ExperimentReq_OrbitMaxArgOfPeriapsis =
                GetLoc("ExperimentReq_OrbitMaxArgOfPeriapsis"); // "Max. argument of Pe "

        public static string
            ExperimentReq_TemperatureMin = GetLoc("ExperimentReq_TemperatureMin"); // "Min. temperature "

        public static string
            ExperimentReq_TemperatureMax = GetLoc("ExperimentReq_TemperatureMax"); // "Max. temperature "
        ...
        public static string
            ExperimentReq_SurfaceSpeedMin = GetLoc("ExperimentReq_SurfaceSpeedMin"); // "Min. surface speed "

        public static string
            ExperimentReq_SurfaceSpeedMax = GetLoc("ExperimentReq_SurfaceSpeedMax"); // "Max. surface speed "

        public static string
            ExperimentReq_VerticalSpeedMin = GetLoc("ExperimentReq_VerticalSpeedMin"); // "Min. vertical speed "

        public static string
            ExperimentReq_VerticalSpeedMax = GetLoc("ExperimentReq_VerticalSpeedMax"); // "Max. vertical speed "
        ...
        public static string
            ExperimentReq_DynamicPressureMin = GetLoc("ExperimentReq_DynamicPressureMin"); // "Min dynamic pressure"

        public static string
            ExperimentReq_DynamicPressureMax = GetLoc("ExperimentReq_DynamicPressureMax"); // "Max dynamic pressure"

        public static string
            ExperimentReq_StaticPressureMin = GetLoc("ExperimentReq_StaticPressureMin"); // "Min. pressure "

        public static string
            ExperimentReq_StaticPressureMax = GetLoc("ExperimentReq_StaticPressureMax"); // "Max. pressure "

        public static string
            ExperimentReq_AtmDensityMin = GetLoc("ExperimentReq_AtmDensityMin"); // "Min. atm. density "

        public static string
            ExperimentReq_AtmDensityMax = GetLoc("ExperimentReq_AtmDensityMax"); // "Max. atm. density "

        public static string
            ExperimentReq_AltAboveGroundMin = GetLoc("ExperimentReq_AltAboveGroundMin"); // "Min ground altitude"

        public static string
            ExperimentReq_AltAboveGroundMax = GetLoc("ExperimentReq_AltAboveGroundMax"); // "Max ground altitude"

        public static string
            ExperimentReq_MaxAsteroidDistance = GetLoc("ExperimentReq_MaxAsteroidDistance"); // "Max asteroid distance"

        public static string
            ExperimentReq_AtmosphereAltMin = GetLoc("ExperimentReq_AtmosphereAltMin"); // "Min atmosphere altitude "

        public static string
            ExperimentReq_AtmosphereAltMax = GetLoc("ExperimentReq_AtmosphereAltMax"); // "Max atmosphere altitude "
        ...
        public static string
            ExperimentReq_CrewCapacityMin = GetLoc("ExperimentReq_CrewCapacityMin"); // "Min. crew capacity "

        public static string
            ExperimentReq_CrewCapacityMax = GetLoc("ExperimentReq_CrewCapacityMax"); // "Max. crew capacity "

        public static string
            ExperimentReq_AstronautComplexLevelMin =
                GetLoc("ExperimentReq_AstronautComplexLevelMin"); // "Astronaut Complex min level "

        public static string
            ExperimentReq_AstronautComplexLevelMax =
                GetLoc("ExperimentReq_AstronautComplexLevelMax"); // "Astronaut Complex max level "

        public static string
            ExperimentReq_TrackingStationLevelMin =
                GetLoc("ExperimentReq_TrackingStationLevelMin"); // "Tracking Station min level "

        public static string
            ExperimentReq_TrackingStationLevelMax =
                GetLoc("ExperimentReq_TrackingStationLevelMax"); // "Tracking Station max level "

        public static string
            ExperimentReq_MissionControlLevelMin =
                GetLoc("ExperimentReq_MissionControlLevelMin"); // "Mission Control min level "

        public static string
            ExperimentReq_MissionControlLevelMax =
                GetLoc("ExperimentReq_MissionControlLevelMax"); // "Mission Control max level "

        public static string
            ExperimentReq_AdministrationLevelMin =
                GetLoc("ExperimentReq_AdministrationLevelMin"); // "Administration min level "

        public static string
            ExperimentReq_AdministrationLevelMax =
                GetLoc("ExperimentReq_AdministrationLevelMax"); // "Administration max level "
