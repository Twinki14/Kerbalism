...
namespace Kerbalism.Modules
{
    public class Laboratory : PartModule, IModuleInfo, ISpecifics, IContractObjectiveModule
    {
        ...
        // localized strings
        private static readonly string localized_title =
            Lib.BuildString("<size=1><color=#00000000>00</color></size>", Local.Laboratory_Title);
        ...
        public void Update()
        {
            ...
            if (Lib.IsFlight())
            {
                ...
                Events["Toggle"].guiName =
                    Lib.StatusToggle(localized_toggle, running ? localized_enabled : localized_disabled);
        }
            ...
            if (running)
            {
                ...
                if (!researcher_cs || researcher_cs.Check(part.protoModuleCrew))
                {
                    ...
                    if (current_sample != null)
                    {
                        ...
                        ec.Consume(ec_rate * Kerbalism.System.Kerbalism.elapsed_s, ResourceBroker.Laboratory);
                        ...
                        {
                            // analyze the sample
                            status = Analyze(vessel, current_sample, rate * Kerbalism.System.Kerbalism.elapsed_s);
        ...
        public static void BackgroundUpdate(Vessel v, ProtoPartSnapshot p, ProtoPartModuleSnapshot m, Laboratory lab,
        ...
        [KSPEvent(guiActive = true, guiActiveEditor = true, guiName = "#KERBALISM_Laboratory_Toggle", active = true,
            groupName = "Science", groupDisplayName = "#KERBALISM_Group_Science")] //"Toggle Lab"Science
        public void Toggle()
        {
            running = !running;
        ...
        [KSPEvent(guiActive = true, guiActiveEditor = false, guiName = "#KERBALISM_Laboratory_Clean", active = true,
            groupName = "Science", groupDisplayName = "#KERBALISM_Group_Science")] //Clean Lab""Science
        ...
        private static Status Analyze(Vessel v, SubjectData subject, double amount)
        {
            ...
            if (sample != null)
            {
                ...
                {
                    Message.Post(
                        Lib.Color(Lib.BuildString(Local.Laboratory_Analysis, " ", Local.Laboratory_stopped),
                            Lib.Kolor.Red), //"stopped"
            ...
            if (completed)
            {
                if (!PreferencesScience.Instance.analyzeSamples)
                {
                    ...
                    Message.Post(Lib.BuildString(Lib.Color(Local.Laboratory_Analysis, Lib.Kolor.Science, true), "\n",
                            Local.Laboratory_Analyzed.Format(Lib.Bold(v.vesselName), Lib.Bold(subject.FullTitle))),
                        localized_results);
                }
        ...
        {
            return localized_title;
        } // Attempt to display at top of tooltip
