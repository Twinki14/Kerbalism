    ...
    public class GravityRing : PartModule, ISpecifics
    {
        ...
        public override void OnStart(StartState state)
        {
            ...
            if (counterWeightRotateIsTransform)
                counterWeightRotate_transf = new Transformator(part, counterWeightRotate, counterWeightSpinRate,
                    counterWeightSpinAccelerationRate, false);
        ...
        public void Update()
        {
            ...
            if (part.IsPAWVisible())
            {
                ...
                Events["Toggle"].active = (deploy.Length > 0) && (part.FindModuleImplementing<Habitat>() == null) &&
                                          !deploy_anim.Playing() && !waitRotation &&
                                          ResourceCache.GetResource(vessel, "ElectricCharge").Amount > ec_rate;
            }
        ...
        public void FixedUpdate()
        {
            ...
            if (Is_consuming_energy())
            {
                ...
                // consume ec
                ec.Consume(ec_rate * Kerbalism.System.Kerbalism.elapsed_s, ResourceBroker.GravityRing);
            }
        }

        public static void BackgroundUpdate(Vessel vessel, ProtoPartSnapshot p, ProtoPartModuleSnapshot m,
            GravityRing ring, ResourceInfo ec, double elapsed_s)
        {
        ...
        // action groups
        [KSPAction("#KERBALISM_GravityRing_Action")]
        ...
        public Specifics Specs()
        {
            ...
            specs.Add(Local.GravityRing_info2,
                deploy.Length > 0 ? Local.GravityRing_yes : Local.GravityRing_no); //"deployable""yes""no"
            return specs;
        }
    }
}