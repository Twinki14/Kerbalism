        ...
        public override string GetInfo()
        {
            ...
            foreach (var pm in this.part.Modules)
            {
                if (pm.moduleName == "ModuleRTAntenna")
                {
                    ...
                    if (packetSize != null && packetInterval != null && packetResourceCost != null &&
                        energyCost != null)
                    {
                        ...
                        specs.Add(Local.DataTransmitter_ECidle,
                            Lib.Color(Lib.HumanOrSIRate(idleEnergyCost, Lib.ECResID), Lib.Kolor.Orange)); //"EC (idle)"
                        specs.Add(Local.DataTransmitter_ECTX + " Max",
                            Lib.Color(Lib.HumanOrSIRate(transmissionEnergyCost + idleEnergyCost, Lib.ECResID),
