...
namespace Kerbalism.Modules
{
    ...
    public interface IKerbalismModule
    {
        ...
        string ResourceUpdate(Dictionary<string, double> availableResources,
        ...
        string PlannerUpdate(List<KeyValuePair<string, double>> resourceChangeRequest, CelestialBody body,
