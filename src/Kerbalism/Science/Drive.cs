...
namespace Kerbalism.Science
{
    public sealed class Drive
    {
                ...
                foreach (var file_node in node.GetNode("files").GetNodes())
                {
                    ...
                    else
                    {
                        ...
                        if (file != null)
                        {
                            ...
                            if (files.ContainsKey(file.subjectData))
                            {
                                Lib.Log("discarding duplicate converted subject " + file.subjectData,
        ...
        public static double StoreFile(Vessel vessel, SubjectData subjectData, double size,
        ...
        public bool Record_file(SubjectData subjectData, double amount, bool allowImmediateTransmission = true,
        ...
        public static void Transfer(Vessel src, Vessel dst, bool samples)
        {
            ...
            if (allMoved)
                ...
                (
                    ...
                    Lib.BuildString(Local.Generic_FROM, " <b>", src.vesselName, "</b> ", Local.Generic_TO, " <b>",
                        dst.vesselName, "</b>")
                );
            else
                Message.Post
