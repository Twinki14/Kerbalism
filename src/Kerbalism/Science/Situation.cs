...
namespace Kerbalism.Science
{
    ...
    public class Situation : IEquatable<Situation>
    {
        ...
        public static bool operator ==(Situation a, Situation b)
        {
            return a.Equals(b);
        }
        ...
        public string BiomeTitle => Biome != null ? Biome.displayname :
            VirtualBiome != VirtualBiome.None ? VirtualBiome.Title() : string.Empty;

        public string ScienceSituationTitle => ScienceSituation.Title();

        public string BodyName => Body.name;

        public string BiomeName => Biome != null ? Biome.name.Replace(" ", string.Empty) :
            VirtualBiome != VirtualBiome.None ? VirtualBiome.Serialize() : string.Empty;
